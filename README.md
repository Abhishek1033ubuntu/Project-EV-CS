# Project EV-CS: High-Performance Ceramic Swarm (v1.2)
...
- **Business Model:** 10-Year Hardware-as-a-Service (HaaS) Lifecycle Leasing model.

## Repository Structure
- `/src`: Contains the physical and financial Python simulation scripts.
- `/docs`: Contains the definitive technical system ledger (PDF).
